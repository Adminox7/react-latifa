    ...
    render() {
        return (
            <div className="bgHome">
                ...
                <div className="comp">
                    <img src="./img/Girlislamik.png" />
                    <h1>Collect. Battle. Play with your NFTs</h1>
                    <p>Felis commodo lectus elit facilisis sed aenean dapibus fusce etiam nibh condimentum laoreet mus urna</p>
                    <input className="btn" type='button' value={"Play Game"} />
                    <input className="btn" type='button' value={"Buy Monster"} />
                </div>
